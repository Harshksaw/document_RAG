...
#     pdf_path = "/data/AIProjects/document_RAG/data/single_document_chat/NIPS-2017-attention-is-all-you-need-Paper.pdf"
...
def test_document_ingestion_and_rag():
    try:
        test_files = [
            "/data/AIProjects/document_RAG/data/multi_doc_chat/market_analysis_report.docx",
            "/data/AIProjects/document_RAG/data/multi_doc_chat/sample.pdf",
            "/data/AIProjects/document_RAG/data/multi_doc_chat/state_of_the_union.txt",
            "/data/AIProjects/document_RAG/data/multi_doc_chat/NIPS-2017-attention-is-all-you-need-Paper.pdf"
